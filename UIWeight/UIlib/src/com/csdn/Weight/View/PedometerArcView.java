...
import com.csdn.Weight.inter.CYAnimator;
...
public class PedometerArcView extends RelativeLayout implements CYAnimator {
	...
	private int processIndex = 70;//进度
	private int j = 0;
	...
	private void inti() {
		...
		this.torusWidth = TypedValue.applyDimension(1, 10.0F, getResources().getDisplayMetrics());
		this.b = new Paint();
	...
	protected void onDraw(Canvas paramCanvas) {
		...
		while (m < n + i1) {
			paramCanvas.drawArc(localRectF, m % a * this.d - 90.0F, this.e, false, this.b);
			m += 1;
		}
	}
}