 ...
 */
public class SizeCheckBox extends CheckBox {

    private int mDrawableSize;// xml文件中设置的大小
    private int mDrawablePadding;

    public SizeCheckBox(Context context) {
        this(context, null, 0);
    }

    public SizeCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SizeCheckBox(Context context, AttributeSet attrs, int defStyle) {
