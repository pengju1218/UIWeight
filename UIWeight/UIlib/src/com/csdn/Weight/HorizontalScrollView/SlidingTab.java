...
public class SlidingTab extends HorizontalScrollView {
    ...
    public void setTitles(List<String> s) {
        this.list = s;
        mLayout.removeAllViews();
        for (int i = 0; i < list.size(); i++) {
            mLayout.addView(addTab(i, list.get(i)));
        }
        scrollToChild(0, 0);
        setSelect(0);
    }
    ...
    private TextView addTab(final int position, String title) {
        ...
        mTextView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setSelect(position);
                if (onTitleSelect != null) {
                    onTitleSelect.select(position);
                }
            }
        });
        return mTextView;
    ...
    public void setOnTitleSelect(SlidingTab.onTitleSelect onTitleSelect) {
