...
public class NiceSpinner extends TextView {
    ...
    private void init(AttributeSet attrs) {
        ...
        this.setBackgroundResource(R.drawable.text_bg);
        ...
        mListView.setBackground(getResources().getDrawable(R.drawable.spinner_bg));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            //mPopup.setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.drawable.spinner_drawable));
        } else {
            //  mPopup.setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.drawable.drop_down_shadow));
        }
        ...
        int w = mDrawable.getIntrinsicWidth()-70;
        int h = mDrawable.getIntrinsicHeight()-70;
